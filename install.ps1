<#
	.SYNOPSIS
		Installs the PSDracoon Module from github
		
	.DESCRIPTION
		This script installs the PSDracoon Module from github.
...
$ModuleName = "PSDracoon"

# Base path to the github repository
$BaseUrl = "https://github.com/<InsertUsernameHere>/PSDracoon"
